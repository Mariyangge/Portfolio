...
public class Main extends JFrame {
	...
	public Main() {
		...
		PanelRound GetToKnowMePanel = new PanelRound();
		...
		GetToKnowMeLabel.setFont(new Font("Cormorant Garamond", Font.PLAIN, 54));
		...
		HobbiesBtn.setFont(new Font("Cormorant Garamond", Font.PLAIN, 15));
		...
		SkillsBtn.setFont(new Font("Cormorant Garamond", Font.PLAIN, 15));
		...
		ExperienceBtn.setFont(new Font("Cormorant Garamond", Font.PLAIN, 15));
		...
		BiyotLabel.setFont(new Font("Cormorant Garamond", Font.PLAIN, 20));
		...
		BiyotLabel2.setFont(new Font("Cormorant Garamond", Font.PLAIN, 20));
		...
		FacebookLogo.addMouseListener(new java.awt.event.MouseAdapter() {
			@Override
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				FacebookLogomouseClicked(evt);
			}
		});

		InstagramLogo.addMouseListener(new java.awt.event.MouseAdapter() {
			@Override
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				InstagramLogomouseClicked(evt);
			}
		});
	...
	private void FacebookLogomouseClicked(java.awt.event.MouseEvent evt) {
		try{
			Desktop.getDesktop().browse(new URL ("https://www.facebook.com/Mariyangge/").toURI());
		}
		catch(Exception e)
		{}
	}

		private void InstagramLogomouseClicked(java.awt.event.MouseEvent evt) {
			try{
				Desktop.getDesktop().browse(new URL ("https://www.instagram.com/mb.yang/").toURI());
			}
			catch(Exception e)
			{}
		}

		private void GithubLogomouseClicked(java.awt.event.MouseEvent evt) {
			try{
				Desktop.getDesktop().browse(new URL ("https://github.com/Mariyangge").toURI());
			}
			catch(Exception e)
			{}}
